...
public class ItripAddCommentVO implements Serializable {
    private static final long serialVersionUID = -6036614665891963954L;
...
//    @ApiModelProperty("[非必填] 评论图片，根据用户是否上传图片（图片网络路径数组）")
    ...
    public Img[] getItripImages() {
        return itripImages;
    }

    public void setItripImages(Img[] itripImages) {
